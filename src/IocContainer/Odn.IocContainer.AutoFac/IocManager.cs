...
namespace Odn.IocContainer.AutoFac
{
    public class IocManager : IIocManager
    {
        ...
        /// </summary>
        public Autofac.IContainer IocContainer { get; private set; }
        ...
        public IocManager()
        {
            ...
            //IocContainer.ComponentRegistry.Register();
        ...
        {
            return IocContainer.IsRegisteredService(type);
        }
