...
namespace Odn.Dependency.Autofac
{
    ...
    public class ContainerManager : IDisposable
    {
        ...
        public virtual object ResolveUnregistered(Type type, ILifetimeScope scope = null)
        {
            ...
            foreach (var constructor in constructors)
            {
                try
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        if (service == null) throw new OdnException("Unkown dependency");
            ...
            throw new OdnException("No constructor  was found that had all the dependencies satisfied.");
        }
        ...
        public virtual ILifetimeScope Scope()
        {
            try
            {
                ...
                //mark: 此处只考虑了asp.net mvc, 并未考虑webapi, 需要多注意
