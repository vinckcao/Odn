...
namespace Odn.Modules
{
    ...
    /// </remarks>
    public abstract class OdnModule
    {
        /// <summary>
        ...
        /// </summary>
        protected internal IOdnStartupConfiguration Configuration { get; internal set; }
        ...
        public static bool IsOdnModule(Type type)
        {
            return
                type.IsClass &&
                !type.IsAbstract &&
                typeof(OdnModule).IsAssignableFrom(type);
        }
